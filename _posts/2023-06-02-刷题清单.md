...
|      | 类似133           | 138 | [](https://leetcode.cn/problems/copy-list-with-random-pointer/description/) |
|      | 并查集模板题          | 547 | [](https://leetcode-cn.com/problems/friend-circles/)                        |
|      | 并查集(矩阵图模拟)      | 130 | [](https://leetcode.cn/problems/surrounded-regions/description/)            |
|      | 并查集(矩阵图模拟)      | 200 | [](https://leetcode.cn/problems/number-of-islands/description/)             |
...
|      | 最短路模板题/Dijkstra | 743 | [](https://leetcode.cn/problems/network-delay-time/)                        |
