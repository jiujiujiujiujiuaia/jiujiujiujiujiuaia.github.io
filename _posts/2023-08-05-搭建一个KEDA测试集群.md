...
## 1.什么是KEDA
KEDA(Kubernetes-based Event Driven Autoscaler)是一种基于事件驱动对 K8S 资源对象扩缩容的组件。非常轻量、简单、功能强大，不仅支持基于 CPU / MEM 资源和基于 Cron 定时 HPA 方式，
...
4.https://azure.github.io/aad-pod-identity/docs/getting-started/installation/
5.https://www.qinglite.cn/doc/58576474bdbb697ea